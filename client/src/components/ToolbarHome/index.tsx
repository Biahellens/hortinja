//componentes
import { AppBar, FormControl, MenuItem, Select, IconButton, InputAdornment, Toolbar, OutlinedInput  } from '@material-ui/core'
...
export const ToolbarHome = () => {
  return(
    <AppBar color='secondary' style={{alignItems:'center', padding:'1vh'}}>
          <Toolbar>
            <img src={Logo} style={{ marginLeft: '10vh', maxHeight:'4vh'}} />
            <div style={{paddingLeft: '25vh'}}>
            <FormControl variant="outlined" style={{marginLeft:'2vh', marginRight:'2vh'}}>
              <Select
